...
public class historialCID extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent(historialCID.this, Acercade.class);
            startActivity(i);
        ...
        if (id == R.id.action_settings1) {
            AlertDialog.Builder adb = new AlertDialog.Builder(historialCID.this);
            adb.setTitle("Salir");
