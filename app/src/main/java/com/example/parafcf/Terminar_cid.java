...
public class Terminar_cid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_terminar_cid);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent(Terminar_cid.this, Acercade.class);
            startActivity(i);
        ...
        if (id == R.id.action_settings1) {
            AlertDialog.Builder adb = new AlertDialog.Builder(Terminar_cid.this);
            adb.setTitle("Salir");
